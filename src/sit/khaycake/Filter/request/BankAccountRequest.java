 ...
 */
public class BankAccountRequest extends MyFilter {
    @Override
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(request.getMethod().equalsIgnoreCase("post")) {
            ...
            req.validate(integerAttribute("BABR_ID", "สาขา"), attribute("ACC_NAME","ชื่อบัญชี"), attribute("ACC_NO","เลขที่บัญชี"),
                    integerAttribute("BAAT_ID", "ประเภท"));
